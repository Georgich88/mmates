...
import com.mmates.parsers.tapology.TapologyBaseObject;
	...
	public List<Loadable> parse(String url) throws IOException {
		...
		return select.stream()
				...
				.map(t -> {
					...
					TapologyBaseObject sherdogObject = new TapologyBaseObject();
					sherdogObject.setName(t.text());
					sherdogObject.setSherdogUrl(TapologyConstants.BASE_URL + t.attr("href"));
